...
void TVShow::create_TVShow()
{
	...
	cout << "  Введите жанр телепередачи(1-спортивыная телепередача, 2-новости, 3-прогноз погоды):  ";
...
{
	cout << "  ИНФОРМАЦИЯ О ТЕЛЕПЕРЕДАЧЕ  ";
	cout << "  Название телепередачи:  " << get_name();
	cout << "  Жанр телепередачи:  " << get_genre();
	cout << "  Съемочная команда:  ";
